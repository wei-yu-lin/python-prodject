    ...
    try:
        ...
        if not df.empty:
            ...
            col_ren = { 'COIL_NO':'捲號','STATION':'產線','DATE_LAST_MAINT':'維護日期','CLASS_CODE':'等級',
                        ...
                        'DEFECT16':'缺陷 週期 類別16','DEFECT17':'缺陷 週期 類別17','DEFECT18':'缺陷 週期 類別18','GLOSS_H':'光澤度H','GLOSS_M':'光澤度M','GLOSS_E':'光澤度E',
                        'GLOSS_H1':'光澤度H1','GLOSS_M1':'光澤度M1'
                      }
